...
CapacitiveSensor cs_4_7 = CapacitiveSensor(4,7);            // pin 4 is sensor pin for foil capacitive sensing

#define CAP_THRESHOLD 1
...
void loop() {
  // if cap sense activated, play beat note (31HZ)
  if (cs_4_7.capacitiveSensor(1) > CAP_THRESHOLD){
    tone(Buzz, 31);
    digitalWrite(LED_BUILTIN, HIGH);   // turn the LED on (HIGH is the voltage level)
                                       // just to show capsense is working
    }
